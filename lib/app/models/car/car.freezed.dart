...
abstract class $CarCopyWith<$Res> {
  ...
  $Res call(
      ...
      @DoubleToStringConvert() double price});
}
...
class _$CarImpl implements _Car {
  _$CarImpl(
      ...
      @DoubleToStringConvert() required this.price});
...
abstract class _Car implements Car {
  factory _Car(
      ...
      @DoubleToStringConvert() required final double price}) = _$CarImpl;
